...
/***/ "./resources/js/routes/xxx/PlanDialog.js":
/*!***********************************************!*\
  !*** ./resources/js/routes/xxx/PlanDialog.js ***!
  \***********************************************/
/*! exports provided: default */
...
(function () {
  ...
  reactHotLoader.register(ConfirmationDialog, "ConfirmationDialog", "E:\\02_web\\05_laravel\\projects\\01_first\\resources\\js\\routes\\xxx\\PlanDialog.js");
  reactHotLoader.register(_default, "default", "E:\\02_web\\05_laravel\\projects\\01_first\\resources\\js\\routes\\xxx\\PlanDialog.js");
})();
...
/***/ "./resources/js/routes/xxx/RsuteTable.js":
/*!***********************************************!*\
  !*** ./resources/js/routes/xxx/RsuteTable.js ***!
  \***********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function(module) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return RsuiteTable; });
...
/* harmony import */ var _PlanDialog__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./PlanDialog */ "./resources/js/routes/xxx/PlanDialog.js");
(function () {
  var enterModule = typeof reactHotLoaderGlobal !== 'undefined' ? reactHotLoaderGlobal.enterModule : undefined;
  enterModule && enterModule(module);
})();
...
/**
 *  nEditStatus = 0     => no eidt, sendButton disable
 *  nEditStatus = 1     => edit,    sendButtong active
 *  nCheckStatus = 0    => no checked
 *  nCheckStatus = 1    => sPrice, tPerform checked
 *  nCheckStatus = 2    => everything checked
 */
...
function RsuiteTable({
  ...
  const [data, setData] = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(planDefaultData); //===== Month Picker ====//

  const pickAMonth = Object(react__WEBPACK_IMPORTED_MODULE_0__["useRef"])(null);
  const [yearMonth, setYearMonth] = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(getCurrentDate());
  const [isPickerShow, setIsPickerShow] = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(false); //== modal ===//

  const [bOpenModal, setBOpenModal] = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(false);
  const [rowData, setRowData] = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])({}); //== handle Month Picker ===?
  ...
  const onDismissPicker = value => {
    console.log("dissmisValue", value);
    setIsPickerShow(false); //== connect server ===//
  }; //=== handle modal ===//


  const onCloseModal = (changedRow, bModified) => {
    setBOpenModal(false);
    console.log("accept row data", changedRow);
    console.log("check modified", bModified);
    if (!bModified) return;
    setData(data.map(row => row.nWeek === changedRow.nWeek ? changedRow : row));
  };
  ...
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    ...
    return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, row.sPrice || "");
  })), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(rsuite_table__WEBPACK_IMPORTED_MODULE_4__["Column"], {
    flexGrow: 3
  }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(rsuite_table__WEBPACK_IMPORTED_MODULE_4__["HeaderCell"], {
    style: _objectSpread({}, styles)
...
(function () {
  ...
  reactHotLoader.register(planDefaultData, "planDefaultData", "E:\\02_web\\05_laravel\\projects\\01_first\\resources\\js\\routes\\xxx\\RsuteTable.js");
  reactHotLoader.register(styles, "styles", "E:\\02_web\\05_laravel\\projects\\01_first\\resources\\js\\routes\\xxx\\RsuteTable.js");
  reactHotLoader.register(pickerLang, "pickerLang", "E:\\02_web\\05_laravel\\projects\\01_first\\resources\\js\\routes\\xxx\\RsuteTable.js");
  reactHotLoader.register(yearRange, "yearRange", "E:\\02_web\\05_laravel\\projects\\01_first\\resources\\js\\routes\\xxx\\RsuteTable.js");
  reactHotLoader.register(defaultYearMonth, "defaultYearMonth", "E:\\02_web\\05_laravel\\projects\\01_first\\resources\\js\\routes\\xxx\\RsuteTable.js");
  reactHotLoader.register(mrange, "mrange", "E:\\02_web\\05_laravel\\projects\\01_first\\resources\\js\\routes\\xxx\\RsuteTable.js");
  reactHotLoader.register(makePickerText, "makePickerText", "E:\\02_web\\05_laravel\\projects\\01_first\\resources\\js\\routes\\xxx\\RsuteTable.js");
  reactHotLoader.register(getCurrentDate, "getCurrentDate", "E:\\02_web\\05_laravel\\projects\\01_first\\resources\\js\\routes\\xxx\\RsuteTable.js");
  reactHotLoader.register(RsuiteTable, "RsuiteTable", "E:\\02_web\\05_laravel\\projects\\01_first\\resources\\js\\routes\\xxx\\RsuteTable.js");
})();
